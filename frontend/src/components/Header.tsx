...
export function Header({ sidebarToggle, setSidebarToggle }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-99999 flex w-full border-gray-200 bg-white lg:border-b dark:border-gray-800 dark:bg-gray-900">
      <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div className="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4 dark:border-gray-800">
          ...
          <a href="/" className="lg:hidden">
            <svg width="91" height="32" viewBox="0 0 91 32" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <text x="40" y="22" fill="currentColor" className="dark:fill-white" fontSize="18" fontWeight="600" fontFamily="Outfit, sans-serif">Xerppy</text>
            </svg>
          </a>
        ...
        <div className="shadow-theme-md w-full items-center justify-between gap-4 px-5 py-4 lg:flex lg:justify-end lg:px-0 lg:shadow-none">
                ...
                <div className="shadow-theme-lg dark:bg-gray-dark absolute -right-[240px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 sm:w-[361px] lg:right-0 dark:border-gray-800">
                  ...
                  <ul className="custom-scrollbar flex h-auto flex-col overflow-y-auto">
                    ...
                    <li>
                      ...
                      >
                        <span className="relative z-1 block h-10 w-full max-w-10 rounded-full">
                          <div className="h-10 w-10 rounded-full bg-success-500 flex items-center justify-center text-white font-semibold">
                            AF
                          </div>
                          <span className="bg-success-500 absolute right-0 bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white dark:border-gray-900"></span>
                        </span>
          ...
          <div className="relative" ref={userDropdownRef}>
            ...
            >
              <span className="mr-3 h-11 w-11 overflow-hidden rounded-full">
                <div className="h-11 w-11 rounded-full bg-brand-500 flex items-center justify-center text-white font-semibold text-lg">
                  {currentUser.name.charAt(0)}
                </div>
              </span>

              <span className="text-theme-sm mr-1 block font-medium">{currentUser.name}</span>

              <svg
                className={`stroke-gray-500 dark:stroke-gray-400 ${userDropdownOpen ? 'rotate-180' : ''}`}
                width="18"
                height="20"
                viewBox="0 0 18 20"
                fill="none"
