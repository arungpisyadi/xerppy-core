      ...
      icon: (
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M10 2C6.22876 2 3.5 4.81448 3.5 8C3.5 11.1855 6.22876 14 10 14C13.7712 14 16.5 11.1855 16.5 8C16.5 4.81448 13.7712 2 10 2ZM2 8C2 3.71248 5.49287 0.5 10 0.5C14.5071 0.5 18 3.71248 18 8C18 9.72789 17.4923 11.3318 16.6144 12.6687L21.4749 17.5251C22.0583 18.1085 22.0583 19.0415 21.4749 19.6249C20.8915 20.2083 19.9585 20.2083 19.3751 19.6249L14.5146 14.7644C13.2671 15.5564 11.7475 16 10 16C5.49287 16 2 12.2875 2 8ZM10 4.5C10.4142 4.5 10.75 4.83579 10.75 5.25V7.25H12.75C13.1642 7.25 13.5 7.58579 13.5 8C13.5 8.41422 13.1642 8.75 12.75 8.75H10.75V10.75C10.75 11.1642 10.4142 11.5 10 11.5C9.58579 11.5 9.25 11.1642 9.25 10.75V8.75H7.25C6.83579 8.75 6.5 8.41422 6.5 8C6.5 7.58579 6.83579 7.25 7.25 7.25H9.25V5.25C9.25 4.83579 9.58579 4.5 10 4.5Z"
            fill=""
          />
        </svg>
      ),
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
          ...
          <div className="space-y-5">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-medium text-gray-800 dark:text-white">23</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-500 dark:text-gray-400">Completed Orders</span>
              <span className="text-sm font-medium text-gray-800 dark:text-white">1,234</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-500 dark:text-gray-400">Cancelled Orders</span>
              <span className="text-sm font-medium text-gray-800 dark:text-white">12</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-500 dark:text-gray-400">Total Sales</span>
              <span className="text-sm font-medium text-gray-800 dark:text-white">$125,430</span>
            </div>
          </div>
        </div>
            ...
            {['Product A', 'Product B', 'Product C', 'Product D'].map((product, i) => (
              <div key={product} className="flex items-center gap-4">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-brand-50 dark:bg-brand-500/10">
                  <span className="text-sm font-semibold text-brand-500">{i + 1}</span>
                </div>
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-800 dark:text-white">{product}</p>
