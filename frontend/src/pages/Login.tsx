              ...
              <div>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="space-y-5">
                    ...
                    {/* Error Message */}
                    {(localError || error) && (
                      <div className="flex items-center gap-2 p-4 rounded-lg bg-error-50 text-error-700 border border-error-200 dark:bg-error-900/30 dark:text-error-400 dark:border-error-800">
                        <svg
                          className="fill-current"
                          width="20"
                          height="20"
